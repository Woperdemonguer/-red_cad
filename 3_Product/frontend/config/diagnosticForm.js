...
export const blocks = [
  ...
  // The form now starts with the diagnostic questionnaire directly.
  {
    ...
    questions: [
      ...
      { id: "1.2a", q: "Si se ha indicado equipo técnico, ¿qué personas se encargan principalmente?", type: "checkbox", options: ["Persona responsable de acción comercial", "Persona directora / coordinadora / gerencia", "Trabajo conjunto entre responsable comercial y dirección"], showWhen: { parentId: "1.2", contains: "Equipo técnico" } },
      ...
      { id: "1.4", q: "Si hay dudas o debates internos respecto a la intercooperación económica, descríbelos brevemente.", type: "textarea", optional: true, tooltip: "La intercooperación económica no es solo intercambiar productos. Si intuyes dudas en tu base social, descríbelos brevemente.", showWhen: { parentId: "1.3", contains: "dudas" } },
      ...
      { id: "1.6a", q: "Si hay acuerdos de precios, ¿cómo se fijan?", type: "textarea", optional: true, tooltip: "Interesa saber si se parte del coste de producción, si hay fichas técnicas de costes, si se negocia con cada socia, etc.", showWhen: { parentId: "1.6", contains: "Sí" } },
      { id: "1.6b", q: "¿Cuáles son los factores que determinan el precio de compra a las personas socias?", type: "radio", options: ["Hay una fundamentación técnica de partida compartida con las personas socias, y a partir de ahí se decide y valida colectivamente", "Hay una fundamentación técnica de partida y está acordado que las personas socias que quieran vender deben aceptar los precios indicados", "No hay una fundamentación técnica precisa; son las personas productoras quienes definen los precios que el equipo gestor acepta"], hasOther: true, hasComment: true, showWhen: { parentId: "1.6", condition: "answered" } },
  ...
  // ─── BLOQUE 4: AUTOEVALUACIÓN E INTERCAMBIOS TÉCNICOS ───
  {
    ...
    questions: [
      { id: "section_4_1", type: "section", title: "Autoevaluación" },
      { id: "4.1", q: "Autoevaluación de madurez por ámbitos.", type: "matrix", tooltip: "Para cada ámbito, indicar en qué nivel se sitúa la agrupación. Es una valoración interna, no hay respuestas correctas o incorrectas.", rows: ["Planificación productiva y coordinación de oferta entre socias", "Gestión comercial y relación con clientes", "Costes de producción y viabilidad económica", "Logística y distribución (rutas, formatos, paletización, envases)", "Calidad, trazabilidad y gestión de auditorías", "Digitalización y uso de herramientas de gestión", "Gobernanza interna y gestión de equipos", "Marketing, comunicación y visibilidad", "Gestión administrativa, fiscal y contable", "Acceso a restauración colectiva y compra pública", "Sistemas de indicadores, medición y evaluación"], columns: ["🔴 Necesitamos apoyo", "🟡 En desarrollo", "🟢 Consolidado"] },
      { id: "4.2", q: "¿En qué ámbitos se podría compartir experiencia o conocimiento con otros CAD?", type: "checkbox", tooltip: "No solo dónde se necesita apoyo, sino qué se puede aportar.", options: ["Planificación productiva y coordinación de oferta entre socias", "Gestión comercial y relación con clientes", "Costes de producción y viabilidad económica", "Logística y distribución", "Calidad, trazabilidad y gestión de auditorías", "Digitalización y uso de herramientas de gestión", "Gobernanza interna y gestión de equipos", "Marketing, comunicación y visibilidad", "Gestión administrativa, fiscal y contable", "Acceso a restauración colectiva y compra pública", "Sistemas de indicadores, medición y evaluación"], hasOther: true, hasComment: true },
  ...
  // ─── BLOQUE 5: OFERTA Y NECESIDADES ───
  {
    ...
    questions: [
      ...
      { id: "5.3", q: "Si existen excedentes o picos, ¿en qué categorías y en qué época del año?", type: "textarea", tooltip: "Indicar las categorías principales y los meses.", showWhen: { parentId: "5.2", contains: "Sí" } },
      ...
      { id: "5.6", q: "¿Qué categorías de producto se necesita adquirir externamente?", type: "checkbox", tooltip: "Cruzando con la oferta de otros CAD se identifican oportunidades.", options: ["Huerta / hortalizas", "Fruta", "Cítricos", "Frutos secos", "Olivar / aceite", "Viña / vino", "Cereales / legumbres", "Carne", "Lácteos", "Huevos", "Apicultura", "Setas / micología", "Plantas aromáticas / medicinales", "Transformados", "Panadería / harinas", "Bebidas"], hasOther: true, hasComment: true, showWhen: { parentId: "5.5", contains: "Sí" } },
      { id: "5.6a", q: "Volumen aproximado anual de compras externas (€).", type: "radio", tooltip: "Dimensiona el potencial de sustitución.", options: ["Menos de 100.000 €", "100.000–300.000 €", "300.001–600.000 €", "Más de 600.000 €"], showWhen: { parentId: "5.5", contains: "Sí" } },
      { id: "5.6b", q: "Origen habitual de las compras externas.", type: "checkbox", tooltip: "¿De dónde viene actualmente el producto externo?", options: ["Proveedores locales/comarcales", "Proveedores autonómicos", "Mayoristas nacionales", "Importación", "Otros CAD de la red"], hasOther: true, hasComment: true, showWhen: { parentId: "5.5", contains: "Sí" } },
      { id: "5.6c", q: "¿Qué factores se priorizan al seleccionar proveedores?", type: "checkbox", tooltip: "Para entender los criterios de compra y diseñar la propuesta de valor.", options: ["Precio", "Calidad del producto", "Certificación ecológica", "Proximidad geográfica", "Fiabilidad y regularidad en el suministro", "Relación de confianza / conocimiento personal", "Condiciones de pago", "Capacidad logística del proveedor", "Valores compartidos (economía social, agroecología)"], hasOther: true, hasComment: true, showWhen: { parentId: "5.5", contains: "Sí" } },
