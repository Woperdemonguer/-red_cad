...
export const MADUREZ_CATEGORIAS = [
    ...
    "Logística y distribución (rutas, formatos, paletización, envases)",
...
export const MADUREZ_TOOLTIPS = {
    ...
    "Logística y distribución (rutas, formatos, paletización, envases)": "Eficiencia en la recogida, almacenamiento (en frío o en seco), preparación de pedidos y distribución física al cliente final o punto intermedio.",
...
export const MADUREZ_KEY_MIGRATION = {
    ...
    "Logística": "Logística y distribución (rutas, formatos, paletización, envases)",
...
export const INTERCOOP_TOOLTIPS = {
    ...
    "Logística y distribución (rutas, formatos, paletización, envases)": "Recogida, almacenamiento, preparación y envío.",
